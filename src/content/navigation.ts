...
export const docsNavigation: DocsSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Atoll Picker", href: "/docs/components/atoll-picker" },
      { title: "Island Picker", href: "/docs/components/island-picker" },
...
export const docsOnThisPage: Record<string, DocsLink[]> = {
  ...
  "/docs/components/island-picker": [
    { title: "Installation", href: "#installation" },
    { title: "Usage", href: "#usage" },
    { title: "Examples", href: "#examples" },
    { title: "Filtering by atoll", href: "#filtering" },
    { title: "RTL behavior", href: "#rtl-behavior" },
  ],
  "/docs/components/location-picker": [
    { title: "Installation", href: "#installation" },
    { title: "Usage", href: "#usage" },
    { title: "Examples", href: "#examples" },
    { title: "Selection behavior", href: "#behavior" },
    { title: "Dhivehi labels", href: "#dhivehi-labels" },
    { title: "Mixed-language names", href: "#mixed-language" },
    { title: "Custom data", href: "#custom-data" },
    { title: "Without a map", href: "#without-map" },
    { title: "Map deployment", href: "#map-deployment" },
    { title: "RTL behavior", href: "#rtl-behavior" },
  ],
